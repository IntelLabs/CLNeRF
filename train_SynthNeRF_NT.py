...
if __name__ == "__main__":
    ...
    for task_curr in range(args.task_number):
        ...
        from utils.nerfacc_radiance_fields.datasets.lb.nerf_synthetic import SubjectLoader_lb as SubjectLoader
        ...
        for epoch in range(10000000):
            ...
            for i in range(len(train_dataset)):
                ...
                #     ),
                # )
                # print("render_step_size = {}".format(render_step_size))
                occupancy_grid.every_n_step(
                    step=step,
                    occ_eval_fn=lambda x: radiance_field.query_opacity(
                        x, render_step_size
...
# evaluation
result_dir = f'results/SynthNeRF/NT_ER/{args.scene}_{args.rep_size}'
