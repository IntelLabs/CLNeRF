...
python merge_video.py \
	"/export/work/zcai/WorkSpace/CLNeRF/CLNeRF/results/WAT/NT_ER/${scene_name}_0/video/rgb.mp4" \
	"/export/work/zcai/WorkSpace/CLNeRF/CLNeRF/results/WAT/EWC/${scene_name}_0/video/rgb.mp4" \
	"/export/work/zcai/WorkSpace/CLNeRF/CLNeRF/results/WAT/NT_ER/${scene_name}_10/video/rgb.mp4" \
