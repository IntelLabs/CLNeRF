...
def get_opts():
    ...
    parser.add_argument('--dataset_name', type=str, default='nsvf',
                        choices=['nerf', 'nsvf', 'nsvf_lb', 'nsvf_CLNerf', 'nsvf_MEILNERF', 'nsvf_lb_MEILNERF', 'nsvf_MEILNERF', 'nsvf_MEILNERF_paper', 'nsvf_CLNerf_MEILNERF', 'nsvf_CLNerf_MEILNERF_paper', 'nsvf_MEIL_MEILNERF_paper', 'nsvf_TaTSeq_CLNerf', 'nsvf_TaTSeq_MEILNERF', 'nsvf_TaTSeq100_MEILNERF', 'nsvf_ngpa', 'nsvf_ngpa_lb', 'nsvf_ngpa_CLNerf', 'phototour', 'phototour_nerfw', 'phototour_nerfw_lb', 'phototour_nerfw_CLNerf', 'phototour_nerfwMS', 'phototour_nerfwMS_lb', 'phototour_nerfwMS_CLNerf', 'phototour_nerfwMS_MEIL', 'colmap', 'colmap_ngpa', 'colmap_ngpa_CLNerf', 'colmap_ngpa_MEIL', 'colmap_ngpa_lb', 'nerfpp', 'nerfpp_lb', 'nerfpp_CLNerf', 'nerfpp_MEIL', 'rtmv'],
    ...
    parser.add_argument('--task_number', type=int, default=5,
                        help='task_number')
    parser.add_argument('--task_curr', type=int, default=4,
    ...
    parser.add_argument('--nerf_rep', type=bool, default=True,
                        help='whether to use nerf replay')                       

    # NGPA param
    parser.add_argument('--vocab_size', type=int, default=10,
                        help='number of embeddings')                       
    parser.add_argument('--dim_a', type=int, default=48,
                        help='dimension of embeddings')                       
    parser.add_argument('--dim_g', type=int, default=16,
                        help='dimension of geometry embeddings')                       

    # phototour param
    parser.add_argument('--num_epochs_eval', type=int, default=5,
                        help='number of training epochs')
    parser.add_argument('--weight_path_eval', type=str, default=None,
                        help='pretrained checkpoint to load (excluding optimizers, etc)')
    # nerfw train test separation
    parser.add_argument('--f_train_val', type=str, default=None,
                        help='training and validation separation file')
    parser.add_argument('--psnr', type=int, default=1,
                        help='whether to measure psnr in ngpa')
    parser.add_argument('--prune_threshold', type=float, default=0.01,
                        help='pruning threshold')
    parser.add_argument('--log2T', type=int, default=19,
                        help='hash table size')
    parser.add_argument('--N_neuron_d', type=int, default=64,
                        help='number of neurons for the depth mlp')
    parser.add_argument('--N_neuron_c', type=int, default=64,
    ...
    parser.add_argument('--N_layers_c', type=int, default=2,
                        help='number of layers for the color mlp')
    
    # warmup
    parser.add_argument('--warmup', type=int, default=0,
                        help='whether to use warmup')
    parser.add_argument('--lr_min', type=float, default=0.033,
