...
parser.add_argument('--is_video', type=int, 
					default=0, help='whether the input is video')

parser.add_argument('--frame_rate', type=int, 
					default=10, help='frame rate to sample images')
...
if __name__=='__main__':
    gen_poses(args.scenedir, args.match_type, args.is_video, args.frame_rate)