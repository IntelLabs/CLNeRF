...
def render_image(
	...
	def sigma_fn(t_starts, t_ends, ray_indices):
		...
		# print("t_origins = {}/{}, positions = {}/{}, task_id = {}/{}, ray_indices = {}/{}, origins = {}/{}".format(t_origins, t_origins.shape, positions, positions.shape, task_id, task_id.shape, ray_indices, ray_indices.shape, chunk_rays.origins, chunk_rays.origins.shape))
		# exit()
	...
	def rgb_sigma_fn(t_starts, t_ends, ray_indices):
		...
		if timestamps is not None:
			...
			return radiance_field(positions, task_id[ray_indices], t, t_dirs)
		return radiance_field(positions, task_id[ray_indices], t_dirs)
